...
<html lang="en">
  ...
  <link href="/resources/css/maintest.css" rel="stylesheet">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 mr-auto">
            <img class="img-fluid" src="/resources/test/ipad.png" alt="">
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto order-lg-1">
            <img class="img-fluid" src="resources/test/dog.png" alt="">
          </div>
        </div>
    ...
    <section class="content-section-a">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-auto ">
            <img class="img-fluid" src="resources/test/phones.png" alt="">
          </div>
        </div>
