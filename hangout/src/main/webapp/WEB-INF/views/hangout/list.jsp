...
<!-- 모임 리스트 -->
   ...
   function callbackSql(result)
      ...
      for (var i = 0, max = hangoutList.length; i < max; i++) {
         ...
         str += "<div class='row justify-content-center align-self-center'>";
         str += "<div class='[ col-xs-12 col-sm-offset-2 col-sm-8 ]'>";
         str += "<ul class='event-list'>";
         str += "<li>";
         str += "<time datetime='2014-07-20'>";
         str += "<span class='day'>" + list.hangoutDate
               + "</span>";
               str += "<span class='month'>Jul</span>";
               str += "<span class='year'>2014</span>";
               str += "</time>";
               str += "<img alt='Independence Day' src='https://farm4.staticflickr.com/3100/2693171833_3545fb852c_q.jpg' />";
               str += "<div class='info'>";
               str += "<h2 class='title'>" + list.hangoutName + "</h2>";
               str += "<p class='desc'>" + list.hangoutContent + "</p>";
               str += "</div>";
               str += "</li>";
               str += "</ul>";
               str += "</div>";
